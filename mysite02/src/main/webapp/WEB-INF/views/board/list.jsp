...
<div id="container">
	...
	<div id="content">
		<div id="board">
				...
				<c:forEach items="${boardList}" var="vo" varStatus="status">
					<tr>
						...
						<td style="text-align:left; padding-left:${vo.depth * 20}px">
							...
							<a href="${pageContext.request.contextPath }/board?a=viewform&id=${vo.id}">${vo.title}</a>
						</td>
						<td>${vo.writer}</td>
						<td>${vo.hit}</td>
						<td>${vo.regDate}</td>
			...
			<div class="bottom">
				<a href="${pageContext.request.contextPath }/board?a=addform&type=original" id="new-book">글쓰기</a>
			</div>
		</div>
	</div>
